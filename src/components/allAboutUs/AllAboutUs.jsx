          ...
          {[
            {
              name: "Sek Pisal",
              role: "Frontend",
              facebook: "https://www.facebook.com/mengeam.seng?mibextid=ZbWKwL",
              github: "https://github.com/MengEam08",
              telegram: "t.me/MengEam_Seng",
            },
            {
              name: "Luy Kanika",
              role: "Frontend",
              facebook:
                "https://www.facebook.com/ka.nika.7737769?mibextid=ZbWKwL",
              github: "https://github.com/Ni-kaaa",
              telegram: "t.me/nikaaaa03",
            },
            {
              name: "Nam Ponleu",
              role: "Frontend",
              facebook: "https://www.facebook.com/nam.ponleu?mibextid=LQQJ4d",
              github: "https://github.com/namponleu",
              telegram: "https://t.me/ponleu07",
            },
            {
              name: "Hong Sreyneang",
              role: "Frontend",
              facebook: "",
              github: "https://github.com/SREYNEANG-HONG",
              telegram: "https://t.me/SREYNEANG_HONG",
            },
            {
              name: "Boen Thi",
              role: "Frontend",
              facebook:
                "https://www.facebook.com/Boen.thi.monster?mibextid=ZbWKw",
              github: "https://github.com/boenthi",
              telegram: "http://t.me/BoenThi",
            },
            {
              name: "Seng Meng Eam",
              role: "Frontend",
            ...
            },
            {
              ...
              role: "Frontend",
              facebook:
                "https://www.facebook.com/profile.php?id=100053897863470&mibextid=ZbWKwL",
              github: "https://github.com/PonChannarith",
              telegram: "t.me/Channarith11",
            },
            {
              name: "Sok Van",
              role: "Frontend",
              facebook: "https://www.facebook.com/van.sok.980?mibextid=ZbWKwL",
              github: "https://github.com/VanSok55",
              telegram: "t.me/VanSok_z",
            },
            {
              name: "Poch Piseth",
              role: "Frontend",
              facebook: "https://web.facebook.com/?_rdc=1&_rdr",
              github: "https://github.com/PochPisethh",
              telegram: "http://t.me/Zwcodecambodia168",
            },
          ].map((member, index) => (
            <div
              key={index}
              className="w-[318.97px] flex-col justify-start items-center inline-flex mb-6"
            >
              <img
                src="../src/assets/Member.jpg"
                alt={member.name}
                className="w-full"
              />
              <div className="h-[82px] flex-col justify-start items-start flex">
                <div className="self-stretch text-center font-suwannaphum text-2xl font-bold text-blue-500">
                  {member.name}
                </div>
                <div className="self-stretch h-[39px] flex-col justify-start items-center flex">
