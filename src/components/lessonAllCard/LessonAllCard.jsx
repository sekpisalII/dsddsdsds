  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-lg w-full">
      ...
      <div className="p-[10px]">
        <h2 className="text-[18px] font-bold text-gray-800 mb-2 font-suwannaphum lesson-card-title">
          {lesson.lesson_title}
        </h2>
        <p className="text-gray-700 text-[17px] leading-tight mt-3 font-suwannaphum line-clamp-2 lesson-card-title">
