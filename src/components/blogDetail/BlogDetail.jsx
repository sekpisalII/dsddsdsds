...
// const BlogDetail = ({ addNotification }) => {
//   const { id } = useParams();
//   const [blog, setBlog] = useState(null);
//   const [isFollowing, setIsFollowing] = useState(false);
//   const [followError, setFollowError] = useState("");
...
//           if (accessToken) {
//             const response = await fetch(
//               `http://136.228.158.126:50001/api/follows/${blogData.author_id}/is_following/`,
//               {
//                 headers: {
//                   Authorization: `Bearer ${accessToken}`,
//                 },
...
//       if (!response.ok) {
//         const errorData = await response.json();
//         throw new Error(errorData.detail || "Failed to update follow status");
//       }
...
//       // Notify parent component of the follow/unfollow action
//       addNotification({
//         id: new Date().toISOString(), // Unique ID for each notification
//         type: newIsFollowing ? "follow" : "unfollow",
//         username: blog.author, // Assuming `blog.author` contains the username
//       });
//     } catch (error) {
//       console.error("Error toggling follow status:", error);
//       setFollowError(error.message);
...
//     <>
//       <div className="mt-10 w-[80%] mx-auto">
//         <span className="font-suwannaphum text-3xl font-bold">Blog Page</span>
//       </div>
//       <section className="mt-5 mb-10 w-full mx-auto font-suwannaphum">
//         <div className="w-full mx-auto md:w-full grid grid-rows-[auto_auto]">
//           <div className="w-full z-10 sticky top-0 h-auto bg-white shadow-sm transition-all duration-300">
